...
/**
 * ColourLabels - This class extends JPanle class, it is used to illustrate the use of 
...
public class ColourLabels extends JPanel {
	...
	MainPanel m;
	Label label1, label2, label3, label4, label5, label6, label7, label8, heightNote;
	JPanel panel1,panel2_1, panel2_2, panel3_1, panel3_2, panel4_1, panel4_2, panel5;
	...
	public ColourLabels(MainPanel m){
		...
		Border titled3 = BorderFactory.createTitledBorder(etched3, "Colour-coding");
