...
/**
 * AnimationThread - this class is used to provide a control of animation for a user, which means the user can
 * use the Next button to control the animation of AVL tree data structure and go step by step through it.
 * 
