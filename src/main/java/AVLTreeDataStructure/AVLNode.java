...
/**
 * AVLNode - this class is used to create a new node that will insert or search for into the AVLTree data structure.
 * Also, it is responsible for drawing this node.
 * 
...
public class AVLNode {
	...
	/**
	 * Constructor for the AVLNode class; to create a node with its initial position
	 * @param avl
	 * 				- AVLTree
	 * @param value
	 * 				- int element value
	...
	/**
	 * This method is used to draw the tree by drawing the lines with their arrowheads that connect nodes
	 * with each other in the tree and then draw these nodes.
	 * @param g
	 * 			- Graphics
	 */
	...
	/**
	 * This method is used to draw the node as a circle and the value of the node
	 * then draw the height of this node above to it.
	 * @param g
	 * 			- Graphics
	 */
	...
	public void drawValue(Graphics g) {
		...
		if (this.value != -1) {
			...
			g.drawString( "" + this.value, this.x - fm.stringWidth(""+this.value) / 2,
	...
	/**
	 * This method is used to from its x and y positions to tox and toy positions
	 * @param node
	 */
	...
	/**
	 * This method is used to set a position to the new node when the tree is empty and it
	...
	/**
	 * This method is used to move the new node or the search node to the 
	 * right side of the tree to insert or search for a number into the tree
	 */
	public void goRight() {
	...
	/**
	 * This method is used to move the new node or the search node to the 
	 * left side of the tree to insert or search for a number into the tree
	 */
	public void goLeft() {
	...
	/**
	 * This method is used to move the new node from its initial position at the top left side
	 * of the screen to be sit at its new position.
	 */
	public void move() {
		if (this.steps > 0) {
