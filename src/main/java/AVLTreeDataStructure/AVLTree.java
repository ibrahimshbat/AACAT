...
/**
 * AVLTree - This class represents Implementation of an AVL Tree, along with code to test insertions on the
 * tree. Based on code written by Mark Allen Weiss in his book Data Structures and
...
public class AVLTree {
	...
	/**
	 * This method resumes the animation and it calls by next button which
	 * used to allow the user to go through the animation step by step.
	 */
	public void next() {
		this.A.myresume();
	}
	...
	/**
	 * Resets the positions of the node based on the width and height of TreeCanvs panel.
	 */
	public void resize() {
		this.radius = 15;
		this.xspan = 12;
